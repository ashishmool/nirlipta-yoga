...
export default function JewelleryByCollection() {
            ...
            <>
                ...
                <div className="sm:container sm:text-left sm:flex text-center justify-between header mt-10 mb-6">
                    <div className="flex flex-col">
                        <h2 className="text-2xl font-bold capitalize">{subTitle} Jewellery</h2>
                        ...
                        <Select onValueChange={e => { setSortByFilter(e) }}>
                            <SelectTrigger className="sm:w-[240px] w-full text-left">
                                ...
                                <SelectValue placeholder={
                                    sortByFilter === 'newest' ? 'Newest Jewelleries' :
                                        sortByFilter === 'oldest' ? 'Oldest Jewelleries' :
