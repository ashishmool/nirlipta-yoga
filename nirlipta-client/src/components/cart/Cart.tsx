...
export default function Cart() {
    ...
    document.title = `Nirlipta Yoga | My Cart`;
    ...
    function handleCopyPerfumeLink(perfumeId: string) {
        ...
        const value = `${window.location.origin}/jewelleries/${perfumeId}`;
                                        ...
                                        <TableCell className="font-medium">
                                            <DropdownMenu>
                                                ...
                                                <DropdownMenuContent className="w-52">
                                                    <Link to={`/jewelleries/${item.productDetails[0].$id}`}>
                        ...
                        <div>
                            ...
                            <Accordion type="single" collapsible>
                                ...
                                <AccordionItem value="question2">
                                    <AccordionTrigger className="text-md font-semibold">What is Nirlipta Yoga's return policy?</AccordionTrigger>
                                    <AccordionContent>
                                        <p className="text-gray-500 dark:text-gray-400">
                                        ...
                                        <div className='mt-[-5px]'>
                                            ...
                                            <div>
                                                <input
                                                    ...
                                                    value={shoppingDetails.cardNumber} className="w-full mt-1 px-3 py-2 border-[1px] border-gray-200 rounded-md focus:outline-none focus:border-indigo-500 transition-colors" placeholder="0000 0000 0000 0000" type="number" />
                                            </div>
                                        </div>
