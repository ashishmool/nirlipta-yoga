    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        if (username == '') {
            ...
            await connectSupport({ username, email, subject, message })
                .then((res) => {
                    if (res == true) {
                        toast.success("Your message sent to Nirlipta Yoga's Customer Support Team successfully")
                        setUsername('')
                        setEmail('')
                        setSubject('')
                        setMessage('')
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <p>
                                We strive to respond to all inquiries within 1-2 business days. For urgent matters, please call our support
                                line.
                            </p>
                        </div>
                    </div>
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center gap-4">
                            <Link
                                to="https://www.linkedin.com/in/ashish-mool//" target='_blank'
                            ...
                            <Link
                                to="https://github.com/ashishmool/emirates-elegance" target='_blank'
                                className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-50"
                            >
