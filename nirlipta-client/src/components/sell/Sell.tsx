...
export default function Sell() {
    ...
    document.title = `Nirlipta Yoga | Sell New Jewellery`;
    ...
    const
        ...
        [selectedSizes, setSelectedSizes] = useState<string[]>([]),
    ...
    const
        ...
        handleSelectedSizes = (newValue: string) => {
            setSelectedSizes((prevSelectedValues) => prevSelectedValues.includes(newValue) ?
        ...
        if (photo1Preview === undefined || photo2Preview === undefined || photo3Preview === undefined) {
            ...
            if (photosUrls.length === 3) {
                await handleCreateProduct({
                    ...
                    setLoadingSubmit(false);
                    setTimeout(() => {
                        navigate(`/jewelleries/${perfumeId}`);
                        // Scroll top
                        window.scrollTo({
                            top: -10,
                            behavior: 'instant'
        ...
        <div>
            ...
            <header className="relative bg-[#F5F5F5] mt-10 py-20 md:py-32 lg:py-40 sm:rounded-xl overflow-hidden">
                ...
                <div className="container mx-auto px-4 md:px-6 lg:px-8 text-center relative z-10">
                    <h1 className="text-4xl font-bold text-white mb-4">Sell Your Luxury Perfumes on Nirlipta Yoga</h1>
                    ...
                    <div className="max-w-3xl mx-auto grid gap-8">
                        <div>
                            ...
                            <p className="text-gray-500 mt-4 text-md">
                                Selling your luxury jewelleries on Nirlipta Yoga is easy. Simply follow these steps:
                            </p>
                            <ol className="mt-6 space-y-4">
                                ...
                                <li className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-500 dark:text-gray-400 mt-2 text-md">
                                            Your jewelleries will be showcased to our niche audience of luxury fragrance enthusiasts.
                                        </p>
                                    </div>
                                </li>
                                <li className="flex items-start gap-4">
                ...
                <div className="grid gap-6 mb-12">
                    <div className="grid gap-2">
                        ...
                        <p className="text-gray-500">
                            Fill out the form below to list a new perfume product on Nirlipta Yoga.
                        </p>
                    </div>
                </div>
                            ...
                            <div className="flex flex-row flex-wrap items-center mt-2">
                                {defaultSizes.map((size) => (
                                    <Button
                                        ...
                                        className={`${selectedSizes.includes(size) ? 'bg-blue-500 text-white' : ''} w-fit mb-2 mr-2`}>
                                        {size}
                                    </Button>
                                ))}
                            </div>
