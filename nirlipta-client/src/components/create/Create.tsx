...
export default function Create() {
    ...
    // set the page title
    document.title = `Nirlipta Yoga | Create a Store`;
                    ...
                    <div className="grid gap-6">
                        ...
                        <div className="grid gap-4">
                            ...
                            <div className="grid gap-2">
                                ...
                                <p className="text-gray-500 text-[15px]">
                                    Store bio is a brief introduction to who you are and what your Store provide. A well-written bio can attract potential buyers by giving them insight into your store personality and expertise in luxury jewelleries.
                                </p>
                            </div>
                            <div className="grid gap-2">
